...
For Each ws In Worksheets
    ...
    For i = 2 To LastRow
        ...
        End If
    Next i
    'Sheets(WorksheetName).Activate /ws.Range("I1:L1").Select / ActiveSheet.Paste/ 'Application.CutCopyMode = False/'Sheets(WorksheetName).Columns("I:L").AutoFit/max = ws.Cells(2, 11)/ min = ws.Cells(2, 11)
